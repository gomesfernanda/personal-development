...
from chapter04_linearalgebra import distance
from chapter05_statistics import mean
...
# Let's look at what happens if we try to predict each city's preferred language using it's neighbors other than itself

# try several different values for k

def predict_actual_cities():
    for k in [1, 3, 5, 7]:
        num_correct = 0
        ...
        print(k, "neighbor[s]:", num_correct, "out of", len(cities))

def plot_grid_neighbors(k=1):
