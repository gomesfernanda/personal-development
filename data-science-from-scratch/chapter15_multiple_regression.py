...
from chapter05_statistics import median, standard_deviation
from chapter06_probability import normal_cdf
from chapter08_gradientdescent import minimize_stochastic
from chapter14_simple_linear_regression import total_sum_of_squares
import random
...
boot_close = bootstrap_statistic(close_to_100, median, 100)
boot_far = bootstrap_statistic(far_from_100, median, 100)

print("bootstrap for random values cpose to 100:", boot_close)
print("bootstrap for random values far from 100:", boot_far)
print("")

########
# Standard errors of regression coefficients
print("********************************************************************************************")
print(("Standard errors of regression coefficients\n").upper())
...
# sometimes it'' called "lambda" but that already means something in Python
...
print("beta 0", beta_0)
print("dot(beta_0[1:], beta_0[1:])", dot(beta_0[1:], beta_0[1:]))
print("multiple_r_squared(x, daily_minutes_good, beta_0)", multiple_r_squared(x, daily_minutes_good, beta_0))

print()
print("alpha = 0.01")
beta_0_01 = estimate_beta_ridge(x, daily_minutes_good, alpha=0.01)
print("beta 0.01", beta_0_01)
print("dot(beta_0_01[1:], beta_0_01[1:])", dot(beta_0_01[1:], beta_0_01[1:]))
print("multiple_r_squared(x, daily_minutes_good, beta_0_01)", multiple_r_squared(x, daily_minutes_good, beta_0_01))

print()
print("alpha = 0.1")
beta_0_1 = estimate_beta_ridge(x, daily_minutes_good, alpha=0.1)
print("beta 0.1", beta_0_1)
print("dot(beta_0_1[1:], beta_0_1[1:])", dot(beta_0_1[1:], beta_0_1[1:]))
print("multiple_r_squared(x, daily_minutes_good, beta_0_1)", multiple_r_squared(x, daily_minutes_good, beta_0_1))

print()
print("alpha = 1")
beta_1 = estimate_beta_ridge(x, daily_minutes_good, alpha=1)
print("beta 1", beta_1)
print("dot(beta_1[1:], beta_1[1:])", dot(beta_1[1:], beta_1[1:]))
print("multiple_r_squared(x, daily_minutes_good, beta_1)", multiple_r_squared(x, daily_minutes_good, beta_1))

print()
print("alpha = 10")
beta_10 = estimate_beta_ridge(x, daily_minutes_good, alpha=10)
print("beta 10", beta_10)
print("dot(beta_10[1:], beta_10[1:])", dot(beta_10[1:], beta_10[1:]))
print("multiple_r_squared(x, daily_minutes_good, beta_10)", multiple_r_squared(x, daily_minutes_good, beta_10))