...
from chapter04_linearalgebra import shape, get_column, make_matrix, magnitude, dot, vector_sum, scalar_multiply, vector_subtract
...
def plot_different_joint_distributions():
...
def de_mean_matrix(A):
    """return the result of subtracting from every value in A the mean
...
def directional_variance(X, w):
    """the variance for the data in the direction determined by w"""
